...
<!-- 
<template>
  <section class="blog-classic section-padding sub-bg">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <div class="item mb-50">
            <div class="img">
              <img src="/dark/assets/imgs/blog/blog1.jpg" alt="" />
            </div>
            <div class="cont">
              <div class="info">
                <div class="date">
          ...
          <div class="item mb-50">
            <div class="img">
              <img src="/dark/assets/imgs/blog/blog2.jpg" alt="" />
            </div>
            <div class="cont">
              <div class="info">
                <div class="date">
          ...
          <div class="item">
            <div class="img">
              <img src="/dark/assets/imgs/blog/blog4.jpg" alt="" />
            </div>
            <div class="cont">
              <div class="info">
                <div class="date">
